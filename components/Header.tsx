    ...
    <nav className="max-sm:px-5 container mx-auto bg-white border-gray-200 dark:bg-gray-900 pt-5">
        ...
        <div className="flex flex-wrap justify-between mx-auto">
            ...
            <div className="hidden lg:block  flex-auto" id="navbar-default">
                <ul className="font-gilbold text-sm uppercase text-black flex flex-col p-4 md:p-0 mt-4 bg-gray-50 md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    <li className="flex-1">
                    ...
                    <li className="flex-1">
                        <a href="#" className="text-center block py-2 px-2 border-r-0 hover:text-white hover:bg-theme-blue border border-black dark:text-white md:dark:text-blue-500" aria-current="page">Художественная мастерская</a>
                    </li>
                    <li className="flex-1">
