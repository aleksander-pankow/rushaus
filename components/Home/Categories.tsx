...
function Categories() {
    return (
        <section className="px-8">
            <div className="w-full flex flex-wrap border-black border-t pt-4 pb-4">
                <div className="w-1/2 sm:w-full md:w-full pr-4 lg:w-1/2 aspect-square">
                    <div className="relative flex h-full border border-black group/item p-8 group/item items-center justify-center">
                        ...
                        <div className="group/details flex justify-between flex-col invisible hover:bg-blue-700 group-hover/item:visible w-full h-full top-0 left-0 absolute p-8 transition ease-in duration-75">
            ...
            <div className="w-full flex flex-wrap border-black border-t pt-4 pb-4">
                <div className="w-1/2 sm:w-full md:w-full pr-4 lg:w-1/2 aspect-square">
                    <div className="h-full border border-black group/item">3</div>
                </div>
                <div className="w-1/2 sm:w-full md:w-full pl-4 border-l border-black lg:w-1/2 aspect-square">
                    <div className="h-full border border-black group/item">4</div>
                </div>
            </div>
            <div className="w-full flex flex-wrap border-black border-t pt-4">
                <div className="w-1/2 sm:w-full md:w-full pr-4 lg:w-1/2 aspect-square">
                    <div className="h-full border border-black group/item">5</div>
                </div>
                <div className="w-1/2 sm:w-full md:w-full pl-4 border-l border-black lg:w-1/2 aspect-square">
                    <div className="h-full border border-black group/item">6</div>
                </div>
            </div>
        </section>
    );
