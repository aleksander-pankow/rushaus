    ...
    let itemList=items.map((item,index)=>{
        return (
            <div key={index} className="w-1/2
                    ...
                    sm:odd:pr-2.5 sm:even:pl-2.5 sm:max-xl:odd:pr-5
                    sm:[&:nth-child(1)]:pb-5 sm:[&:nth-child(2)]:pb-5
                    xl:odd:px-5 sm:even:pl-5
                    sm:[&:nth-child(1)]:border-b
                    sm:[&:nth-child(2)]:border-b sm:[&:nth-child(2)]:border-l [&:nth-child(2)]:border-black
                    sm:[&:nth-child(3)]:pt-5
                    sm:[&:nth-child(4)]:pt-5 sm:[&:nth-child(4)]:border-l [&:nth-child(4)]:border-black
    ...
    return (
        <section className="border border-black border-t-0 p-5">
            <div className="flex flex-col xl:flex-row">
                <div className="relative w-full sm:max-xl:flex-row sm:max-xl:flex xl:w-1/2 h-auto group/item xl:pr-5">
                        <div className="flex flex-col justify-between sm:max-xl:w-1/2 max-sm:h-[calc(50%)] xl:h-[calc((100%/2)-1.5rem)] p-[30px] border border-black">
                            <div className={""}>
                                <h4 className="font-gilbold uppercase text-lg lg:text-rhtitle mb-2">Городские сны</h4>
                                <p>Международный арт проект</p>
                                <p>фотография, живопись, графика, скульптура</p>
                            </div>
                            <div>
                                <h4 className="max-md:mt-4 font-gilbold uppercase text-lg lg:text-rhtitle">До 30 апреля 2024</h4>
                            </div>
                        </div>
                        <div className="max-sm:h-[calc(50%)] xl:h-[calc((100%/2)+1.5rem)] sm:max-xl:w-1/2 bg-blue-900">
                            <img
                                src="/images/test/test-event-picture.png"
                                alt="My Image"
                                className="object-fill h-full w-full"
                ...
                <div className="w-full h-auto flex flex-wrap border-black max-sm:mt-0 max-xl:mt-5 xl:border-l xl:w-1/2">
                    {itemList}
                    <div className="pl-5 pt-5 w-full xl:w-1/2 text-base md:text-rhbuttons text-black font-gilbold uppercase flex max-xl:items-center max-xl:justify-center">
