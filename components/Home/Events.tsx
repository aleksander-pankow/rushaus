    ...
    let itemList=items.map((item,index)=>{
        return (
            <div key={index} className="w-1/2
                    ...
                    sm:[&:nth-child(1)]:pr-5
                    sm:[&:nth-child(2)]:border-l sm:[&:nth-child(2)]:px-5 sm:max-lg:[&:nth-child(2)]:pr-0
                    lg:[&:nth-child(3)]:border-l lg:[&:nth-child(3)]:pl-5 sm:max-lg:[&:nth-child(3)]:pt-5 sm:max-lg:[&:nth-child(3)]:pr-5
                ...
                <div className="relative h-full">
                    ...
                    <div className="flex flex-col justify-between content absolute backdrop-blur-md bg-white/20 w-full h-full left-0 top-0 p-[30px] text-white pb-5">
                        <div>
                            <h4 className="font-gilbold uppercase text-rhregular lg:text-rhtitle mb-2">07.11.2023</h4>
                        </div>
        ...
        <section className="border border-black border-t-0 p-5">
            <div className="flex flex-col xl:flex-row">
                <div className="w-full  h-auto flex flex-wrap border-black max-lg:mt-0 max-xl:mt-5">
                    <div className="relative w-full sm:w-1/2 lg:w-1/3 sm:max-xl:flex-row sm:max-xl:flex h-auto group/item sm:pr-5 max-md:h-44 md:max-xl:h-52 max-sm:mb-4">
                        <div className="flex flex-col justify-between w-full h-full p-[30px] border border-black sm:aspect-square">
                            <div className={""}>
                                <h4 className="font-gilbold uppercase text-rhregular lg:text-rhtitle mb-2">Городские сны</h4>
