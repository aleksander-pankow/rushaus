...
import DaysList from "@/components/Days/DayList"; // Ensure correct path to DateComponent
...
const PostMeta: React.FC<PostMetaProps> = ({ date, time, place, days }) => {
    return (
